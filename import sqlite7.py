...
class CalendarTab(BoxLayout):
    ...
    def __init__(self, finance_manager, **kwargs):
        ...
        # Быстрые действия
        quick_actions = BoxLayout(size_hint=(1, 0.08), spacing=10)
        btn_add_income = Button(text='+ Доход', size_hint=(0.5, 1), background_color=(0.2, 0.8, 0.4, 1))
        btn_add_expense = Button(text='- Расход', size_hint=(0.5, 1), background_color=(0.8, 0.3, 0.3, 1))
        ...
        scroll = ScrollView(size_hint=(0.1, -0.0))
    ...
    def get_day_color(self, transactions):
        ...
        if balance > 0:
            return (0.8, 1, 0.8, 1)  # Зеленый - положительный баланс
        elif balance < 0:
            return (1, 0.8, 0.8, 1)  # Красный - отрицательный баланс
        else:
